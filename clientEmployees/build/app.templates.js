...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('sections/home/home.tpl.html',
    ...
    '              Admin</h5>\n' +
    '            <h6 class="media-heading" style="color:white;text-align: center;">aman@fancymonk.com</h6>\n' +
    '          </div>\n' +
    '        </div>\n' +
    '      </div>\n' +
    '    </li><br>\n' +
    ...
    '        </div>\n' +
    '\n' +
    '        <md-switch ng-model="comingDecision" aria-label="Switch 2" ng-true-value="\'Yes\'" ng-false-value="\'Nope\'" class="md-warn"\n' +
    '          ng-disabled="!selectedItem">\n' +
    '          Are you coming tomorrow? : {{ comingDecision }}\n' +
    '        </md-switch>\n' +
    '\n' +
    '        <md-button class="md-raised md-primary" ng-disabled="!selectedItem" ng-click="addTolist(comingDecision)">Primary</md-button>\n' +
    '\n' +
    '\n' +
    '\n' +
    '        <div class="list">\n' +
