clientApp.controller('ClientDashboardController', ['$scope',
  function($scope) {
    console.log("hello i am isnide login contriller");
               ...
               $scope.Feedback =[ 
               {Feedback:1, feedback:"pallavi", overAllRating:"3", presentationRating:"4", qualityRating:"2", quantityRating:"3", tasteRating:"4",  mobile:"9981045016", date:"27/03/1992", comment:"hahaha" },
               {Feedback:1, feedback:"pallavi", overAllRating:"3", presentationRating:"4", qualityRating:"2", quantityRating:"3", tasteRating:"4",  mobile:"9981045016", date:"27/03/1992", comment:"hahaha"}
               ];
